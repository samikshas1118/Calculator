...
int is_func(const char *t) {
    return (!strcmp(t,"sin") || !strcmp(t,"cos") || !strcmp(t,"tan") ||
            ...
            !strcmp(t,"exp") || !strcmp(t,"log10") ||
            !strcmp(t,"asin") || !strcmp(t,"acos") ||
            !strcmp(t,"atan") || !strcmp(t,"mod"));
}
...
void compute(const char *input, double start, double end,
             double step, char *output) {
